/*
 * The source code of this file was taken from https://github.com/viniciuschiele/Scrypt
 * License: https://github.com/viniciuschiele/Scrypt/blob/master/LICENSE
 */
...
namespace PoissonSoft.CommonUtils.Cryptography
{
    ...
    public class ScryptEncoder
    {
        ...
        /// </summary>
#if COREFX
        private static readonly RandomNumberGenerator DefaultSaltGenereator = RandomNumberGenerator.Create();
#else
        private static readonly RandomNumberGenerator DefaultSaltGenereator = new RNGCryptoServiceProvider();
#endif
        /// <summary>
        ...
        public bool Compare(string password, string hashedPassword)
        {
            ...
            ExtractHeader(hashedPassword, out var version, out var iterationCount, out var blockSize,
                out var threadCount, out var saltBytes);
        ...
        /// </summary>
        public static unsafe byte[] CryptoScrypt(byte[] password, byte[] salt, int N, int r, int p, int keyLength = 32)
        {
